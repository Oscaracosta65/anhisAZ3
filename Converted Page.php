 ...
 * - game_id = AZ3
 * - non-daily game
 * - pick-6 game: all 6 balls are regular balls (no bonus/star ball)
...
$latestMainBalls = [$p1, $p2, $p3, $p4, $p5, $pb];
...
[$mainCounts, $mainLastSeenIndex] = leInitRange(1, 44);
 ...
 * --------------------------------------------------------------------------
 */
$mainChartLabels = leBuildNaturalLabels(1, 44);
$mainChartValues = [];
$mainRecencyValues = [];
...
[$counts50, ] = leInitRange(1, 44);
[$counts300, ] = leInitRange(1, 44);
 ...
 * --------------------------------------------------------------------------
 */
$heroInsight = 'Latest verified draw and recent number behavior at a glance. Review the most active numbers, quiet stretches, and full historical frequency across all 6 drawn positions before moving into deeper SKAI analysis.';
$overviewNote = 'Frequency shows historical occurrence within the selected window across all 6 ball positions. It can help identify recent concentration and quiet periods, but it should be interpreted as context rather than prediction.';
?>
<style>
:root{
  --skai-blue:#1C66FF;
      ...
      <div class="skai-hero-top">
        ...
        <div class="skai-hero-copy">
          ...
          <div class="skai-hero-actions" aria-label="Primary actions">
            <a class="skai-btn skai-btn--primary" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=AZ3">
              Open SKAI Analysis
            </a>
            <a class="skai-btn skai-btn--secondary" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=AZ3">
              AI Predictions
            </a>
          ...
          <div class="skai-advanced-links" aria-label="Advanced tools">
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=AZ3">Skip &amp; Hit Analysis</a>
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=AZ3">MCMC Markov Analysis</a>
            <a class="skai-mini-link" href="/all-lottery-heatmaps?gameId=AZ3">Heatmap Analysis</a>
          </div>
        </div>
  ...
  <section class="skai-strip" aria-label="Key takeaways">
    ...
    <article class="skai-stat">
      ...
      <div class="skai-stat-body">
        ...
        <div class="skai-stat-note">Numbers from the latest draw that also appeared in the recent trailing draws (all 6 positions).</div>
      </div>
    </article>
    ...
    <article class="skai-stat">
      ...
      <div class="skai-stat-body">
        ...
        <div class="skai-stat-note">Draw window currently loaded for this page view. All 6 ball positions are included in the analysis.</div>
      </div>
    </article>
  </section>
  ...
  <section id="frequency-deep-dive" class="skai-section" aria-labelledby="frequency-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Move from summary to full reference. The left panel shows the complete number distribution across all values 01&ndash;44 drawn in any of the 6 positions. The right panel shows recency — how long ago each number last appeared.
        </p>
      </div>
    </div>
      ...
      <div class="skai-two-col">
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--horizon">
            ...
            <span class="skai-card-sub">All values 01&ndash;44 across the last <?php echo (int) $nodCurrentMain; ?> drawings (all 6 positions)</span>
          </div>
          <div class="skai-card-body">
        ...
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--ember">
            ...
            <span class="skai-card-sub">Draws since last appearance for each value 01&ndash;44</span>
          </div>
          <div class="skai-card-body">
            <div class="skai-chart-frame skai-chart-frame--tall">
  ...
  <section id="tables" class="skai-section" aria-labelledby="tables-title">
    ...
    <div class="skai-section-body">
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--horizon">
            Numbers table
            <span class="skai-card-sub">Exact counts and recency for values 01&ndash;44 (all 6 positions)</span>
          </div>
      ...
      <div class="skai-tool-grid">
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=AZ3">Open SKAI Analysis</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=AZ3">Open AI Predictions</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=AZ3">Open Skip &amp; Hit</a>
          </div>
        </article>
      </div>

      <div class="skai-utility-grid">
        <a class="skai-utility-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=AZ3">MCMC Markov Analysis</a>
        <a class="skai-utility-link" href="/all-lottery-heatmaps?gameId=AZ3">Heatmap Analysis</a>
